<template>
    ...
    <section class="indice5" id="indice5">

        <div class= "indice-body">
        
            <div class="indice5-body-container">

                <div class="indice5-body-content">

                    <div class="indice5-body-img">
                        <img class="card-core-aliens-img" src="../assets/background/web/aliens.png">
                    </div>

                    <div class="indice5-body-core">
                        <p class="indice5-body-name">{{this.part}}</p>
                        <p class="indice5-body-text">{{this.description}}</p>
                    </div>
...
export default 
{
    ...
    data() 
    {
        return {
            ...
            queue: [],
            counter : 0,
            phrases : ['transmission en cours\nidentité: inconnu\nprovenance: inconnu'],
            description: "",
            queue1: [],
            counter1 : 0,
            phrases1 : ['humain, communication pleinement opérationnel. nous demandons autorisation d\'attérir sur terre afin d\'établir le premier contact'],
        }
    },
